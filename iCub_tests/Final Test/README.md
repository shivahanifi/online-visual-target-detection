...
- Result
     ...
     <img src="/home/suka/code/online-visual-target-detection/iCub_tests/Final Test/img/result.png" alt="Result" width="600"/>
...
1. The module is less accurate when the visually attended area is on the outer left side of the scene. To be more clear, out of 11 error cases, 6 are related to this situation (% 54.54).
    ...
    <img src="/home/suka/code/online-visual-target-detection/iCub_tests/Final Test/img/session1-elisa-masterchef.png" alt="session1-elisa-masterchef" width="200"/>

    <img src="/home/suka/code/online-visual-target-detection/iCub_tests/Final Test/img/session5-shiva-driller.png" alt="session5-shiva-driller" width="200"/>
